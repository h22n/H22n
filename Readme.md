<p align="center">
  <img src="https://capsule-render.vercel.app/api?type=soft&color=0:FFD700,100:FF4500&height=12&font=Press+Start+2P&section=header&animation=fadeIn" />
  <br><br>
  <img src="https://sfile.chatglm.cn/images-ppt/d851511bdb54.jpg" width="220" height="220" style="border-radius: 50%; border: 4px solid #FFD700; box-shadow: 0 0 25px #FF8C00, inset 0 0 25px rgba(255,215,0,0.3); transition: all 0.3s ease;" onmouseover="this.style.transform='scale(1.05) rotate(5deg)'" onmouseout="this.style.transform='scale(1)'" />
</p>
